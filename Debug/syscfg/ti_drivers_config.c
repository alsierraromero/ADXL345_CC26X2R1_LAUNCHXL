...
GPIO_PinConfig gpioPinConfigs[31] = {
    ...
    /* Owned by I2C_ACCEL as SCL */
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_UP_INTERNAL, /* CONFIG_GPIO_I2C_ACCEL_SCL */
    /* Owned by I2C_ACCEL as SDA */
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_UP_INTERNAL, /* CONFIG_GPIO_I2C_ACCEL_SDA */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_HIGH, /* CONFIG_GPIO_LED_0 */
...
const uint_least8_t CONFIG_GPIO_I2C_ACCEL_SDA_CONST = CONFIG_GPIO_I2C_ACCEL_SDA;
const uint_least8_t CONFIG_GPIO_I2C_ACCEL_SCL_CONST = CONFIG_GPIO_I2C_ACCEL_SCL;
...
const I2CCC26XX_HWAttrsV1 i2cCC26xxHWAttrs[CONFIG_I2C_COUNT] = {
    ...
    /* BAS Sensors Mark II I2C */
    {
        ...
        .intPriority = (~0),
        .swiPriority = 0,
        .sclPin      = CONFIG_GPIO_I2C_ACCEL_SCL,
        .sclPinMux   = IOC_PORT_MCU_I2C_MSSCL,
        .sdaPin      = CONFIG_GPIO_I2C_ACCEL_SDA,
